...
五项必须同时成立才记为阶段 1 `GO`。判据的机器结果见 `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/summary.json`。
...
![三个代表时刻中全部保留的路径](../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/figures/selected_full_multipath_scenes.png)
...
下表直接由 `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/trajectory_and_geometry.csv` 生成。`r_true` 是手机坐标参考点到人体中心的向量；人体中心等于该时刻手机位置加 `r_true`。最后一列是动态真值场景实际保留的总路径数。
...
![真实、含噪和 RTS 几何轨迹](../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/figures/geometry_trajectory.png)
...
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/trajectory_and_geometry.csv`：20 个时刻的手机位置、姿态、真值、含噪和 RTS 几何；
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/geometry_solve_inventory.csv`：960 个主体求解的逐阶路径计数；
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/runtime.json`：软件版本、GPU、运行时间和核心配置；
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/solver_audit.json`：路径上限、重建误差、重复确定性和采样收敛；
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/group_metrics_repeats.csv`：7 组×200 次的逐次指标；
- `../../../../../../pipelines/witwin/experiments/wgeo_stage1/outputs/data/group_summary.csv` 和 `summary.json`：最终汇总与 Go/No-Go 判定。
