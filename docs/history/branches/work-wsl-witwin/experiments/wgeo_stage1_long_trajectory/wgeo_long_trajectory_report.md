...
![长轨迹、人体、D4观测和固定AP](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/long_trajectory_scene.png)
...
![代表空间区块的全部最多三阶传播路径](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/representative_full_multipath_scenes.png)
...
![D0--D5实际几何误差分布和逐区块均值](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/geometry_condition_errors.png)
...
![校准前的直接几何--信道敏感性和路径集合变化](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/direct_geometry_sensitivity.png)

时间热图进一步说明：几何误差在5个区块中分布相近，但CSI响应高度依赖空间链路状态；Z3的弱信号NLOS条件将相同量级的几何误差放大成更大的归一化误差。D5每区块局部索引10--11的突发也在上图形成规则的高误差条纹。

![几何误差与直接CSI误差沿长轨迹的对应关系](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/error_and_channel_timeline.png)
...
![空间留一预测、theta参数污染和逐区块NRMSE](../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/figures/spatial_cv_results.png)
...
最近一次完整强制运行耗时 **209.217秒**，其中主体和审计路径求解 **179.260秒**。原始路径基、逐场景路径数和所有统计重复均保存在 `../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/data`。
...
- 总汇总：`../../../../../../pipelines/witwin/experiments/wgeo_stage1_long_trajectory/outputs/data/summary.json`；
