...
- `workspace/project-docs/前置深度增强的科研项目待办与验证计划.md`
- `docs/IPHONE_11_PRO_IMPLEMENTATION_CONTEXT.md`
- `pipelines/reconstruction/README.md`

## 1. 用户问题

> 根据 `witwin-workspace/workspace/project-docs/前置深度增强的科研项目待办与验证计划.md`，调研相关领域的论文和综述，告诉我用 iPhone 所拿到的 IMU 和视频，在没有 LiDAR 和有 LiDAR 两种情况下，通过 SLAM 做空间环境建模的最佳 SLAM 算法或其他算法是什么？
